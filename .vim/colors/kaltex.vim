...
hi Normal ctermbg=Black ctermfg=white cterm=NONE guibg=gray99 guifg=Black gui=none
...
if has("folding")
  hi Folded ctermbg=none ctermfg=bg cterm=NONE guibg=none guifg=DarkBlue gui=none
...
hi Comment	    guibg=Grey96	guifg=#228b22
...
"hi String ctermbg=bg ctermfg=darkMagenta guibg=bg guifg=darkMagenta gui=none
"hi Constant ctermbg=bg ctermfg=Yellow guibg=bg guifg=DarkGreen gui=none
hi Constant ctermbg=bg ctermfg=darkMagenta guibg=bg guifg=darkMagenta gui=none
hi String ctermbg=bg ctermfg=Yellow guibg=bg guifg=DarkGreen gui=none
"hi link Number Constant
"hi link Float Constant
hi Number guifg=darkorange
hi Float guifg=darkorange
...
hi Conditional guifg=red "gui=bold
...
hi MatchParen ctermbg=White ctermfg=Black cterm=NONE guibg=Green guifg=blue gui=none
